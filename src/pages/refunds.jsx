    ...
    <PageWrapper>
      ...
      <Wrapper>
        <Group>
          ...
          <p>
            To be eligible for a full refund, your item must be unopened and in
        ...
        <Group>
          ...
          <p>
            Once your return claim is approved or rejected, we will send you an
            email to notify you.
          </p>
          <p>
        ...
        <Group>
          ...
          <p>
            ...
            to you, you’ll receive a product replacement for the value of your
            return. Once the returned item is received, a replacement product
        ...
        <Group>
          ...
          <p>
            ...
            returning your item. Shipping costs are non-refundable. Depending on
